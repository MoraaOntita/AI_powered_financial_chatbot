...
def process_question(question: str) -> Optional[str]:
    ...
    """
    try:
        # Check for specific company and financial metrics
        ...
        elif "Tesla" in question and "net income" in question:
            data = fetch_financial_data("Tesla", 2023)
            if data:
                return f"Tesla's net income for 2023 was ${data['net_income']:,} million."
        
        elif "Apple" in question and "total assets" in question:
            data = fetch_financial_data("Apple", 2023)
            if data:
                return f"Apple's total assets for 2023 were ${data['total_assets']:,} million."
